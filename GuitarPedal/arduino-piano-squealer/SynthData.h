...
extern const prog_uint8_t boy1Table[] ;
extern const prog_uint8_t sineTable[] ;
extern const prog_uint8_t triTable[] ;
extern const prog_uint8_t casioTable[] ;
extern const prog_uint8_t noizTable[] ;
extern const prog_uint8_t squareTable[] ;
#endif
